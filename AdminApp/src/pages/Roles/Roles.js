                                       ...
                                       <td>
                                          {
                                             permissionName && permissionName.length > 0 && permissionName.includes('edit_role') ?
                                                <Link to={`/admin/edit-role/${role?._id}`} className='btn btn-primary me-2 text-decoration-none text-light'>Edit</Link>
                                                :
                                                null
                                          }
                                          {
                                          ...
                                          }
                                          {
                                             permissionName && permissionName.length > 0 && permissionName.includes('view_permissions_per_role') ?
                                                <Link to={`/admin/permission-per-role/${role?._id}`} className='btn btn-warning me-2 text-decoration-none text-light'>View Details</Link>
                                                :
                                                null
                                          }
