                  ...
                  <div className="content-box">
                     ...
                     <form onSubmit={handleSubmit(handleSave)}>
                        ...
                        {/* <div className="form-group col-md-12 pt-2">
                           ...
                           <Form.Select name="destinationCurrency" {...register('destinationCurrency', addLeverageData?.destinationCurrency)}>
                              <option value="">Select Destination Currency</option>
                              {currencies && currencies.length > 0 && currencies.map((currency) => {
                                 return (
                                    <option value={currency._id} key={currency._id}>{currency.name} {`(${currency.symbol})`}</option>
                                 )
                              })}
                           </Form.Select>
                           {errors?.destinationCurrency && <span className="errMsg">{errors.destinationCurrency.message}</span>}
                        </div> */}
                        <div className="form-group col-md-12 pt-2">
                        ...
                        <div>
                           <button className="btn-default hvr-bounce-in nav-button" type="submit">Save</button>
                        </div>
                     </form>
                  </div>
               </div>
