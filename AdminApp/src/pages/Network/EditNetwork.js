...
const EditNetwork = () => {
   ...
   const handleSubmit = (e) => {
      ...
      // else if (!chainId) {
      //    setChainIdErr("Please enter Chain Id");
      // } else if (!rpcURL) {
      //    setRpcURLErr("Please enter RpcURL");
      // } else if (!multicallAddress) {
      //    setMultiCallAddressErr("Please enter Multi-Call Address");
      // } else if (!type) {
      //    setTypeErr("Please enter Type");
      // } else if (!explorerURL) {
      //    setExplorerURLErr("Please enter Explorer URL");
      // } 
      else {
         let tempIds = [];
