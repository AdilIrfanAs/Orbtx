                    ...
                    <div className='row'>
                        <div className='col-md-8'>
                            ...
                            <div className='trade-anyway-content'>
                                <h1 className='text-white'>Trade Anywhere <span className='text-gray'>Anytime.</span></h1>
                                <p className='text-white'>Compatible with multiple devices, start trading with safety convenience.</p>
                            </div>
                        </div>
