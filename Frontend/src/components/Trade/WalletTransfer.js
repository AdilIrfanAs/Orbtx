                                    ...
                                    <Modal.Body>
                                          <div className="transfer-modal-content text-center">
                                                ...
                                                <div className="min-half-max-btns">
                                                      <button type="button" className="btn text-green" onClick={() => setAmount(haveAmount > 0 ? parseFloat(selectedCurrency?.minAmount).toFixed(4) : 0)}>
                                                            MIN
                                                      </button>
                                                      <button type="button" className="btn" onClick={() => setAmount(haveAmount > 0 ? (parseFloat(haveAmount) / 2).toFixed(4) : 0)}>
                                                            HALF
                                                      </button>
                                                      <button style={{ border: "0" }} type="button" className="btn" onClick={() => setAmount(haveAmount > 0 ? parseFloat(haveAmount).toFixed(4) : 0)}>
                                                            MAX
                                                      </button>
                                                </div>
