...
exports.store = async (req, res) => {
    try {
        const data = { ...req.body };
        // console.log(parseFloat((parseFloat(data.qty) * parseFloat(data.tradeStartPrice)).toFixed(4)) , parseFloat((parseFloat(data.userInvestedAmount) * parseFloat(data.leverage)).toFixed(4)));
        // console.log(parseFloat((parseFloat(data.qty) * parseFloat(data.tradeStartPrice)).toFixed(4)) < parseFloat((parseFloat(data.userInvestedAmount) * parseFloat(data.leverage)).toFixed(4)));
